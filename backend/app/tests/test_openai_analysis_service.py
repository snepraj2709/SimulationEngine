...
def test_normalize_product_understanding_builds_normalized_payload() -> None:
    ...
    payload = ProductUnderstandingResponse(
        ...
        confidence_scores={"company_name": 0.9, "category": 0.84},
    ...
    payload = AnalysisArtifactsResponse(
        icps=[
            GeneratedICPResponse(
                ...
                driver_weights={"price_affordability": 2, "automation_coverage": 1, "analytics_depth": 1},
            ...
            GeneratedICPResponse(
                ...
                driver_weights={"team_enablement": 0, "support_reliability": 0, "feature_completeness": 0},
            ...
            GeneratedICPResponse(
                ...
                driver_weights={"budget_predictability": 4, "implementation_complexity": 1, "price_affordability": 1},
        ...
        scenarios=[
            GeneratedScenarioResponse(
                ...
                description="desc",
                input_parameters={"price_change_percent": 12, "current_price_estimate": 100},
            ),
            GeneratedScenarioResponse(
                title="Add premium forecasting",
                scenario_type="premium_feature_addition",
                description="desc",
                input_parameters={"premium_feature": "forecasting", "price_change_percent": 8},
            ),
            GeneratedScenarioResponse(
                title="Remove export",
                scenario_type="feature_removal",
                description="desc",
                input_parameters={"removed_feature": "csv export", "feature_importance": 0.8},
            ),
        ],
    )
    ...
    payload = AnalysisArtifactsResponse(
        icps=[
            GeneratedICPResponse(
                ...
                pain_points=["pain 1", "pain 2"],
                decision_drivers=["price_affordability", "automation_coverage", "analytics_depth"],
                driver_weights={"price_affordability": 1, "automation_coverage": 1, "analytics_depth": 1},
            ...
            GeneratedICPResponse(
                ...
                pain_points=["pain 1", "pain 2"],
                decision_drivers=["team_enablement", "support_reliability", "feature_completeness"],
                driver_weights={"team_enablement": 1, "support_reliability": 1, "feature_completeness": 1},
                price_sensitivity=0.4,
                switching_cost=0.3,
                alternatives=["competitor"],
                churn_threshold=-0.2,
            ...
            GeneratedICPResponse(
                ...
                pain_points=["pain 1", "pain 2"],
                decision_drivers=["budget_predictability", "implementation_complexity", "price_affordability"],
                driver_weights={"budget_predictability": 1, "implementation_complexity": 1, "price_affordability": 1},
                price_sensitivity=0.6,
                switching_cost=0.2,
                alternatives=["in-house"],
                churn_threshold=-0.17,
        ...
        scenarios=[
            GeneratedScenarioResponse(
                ...
                scenario_type="pricing_increase",
                description="desc",
                input_parameters={"current_price_estimate": 100},
            ),
            GeneratedScenarioResponse(
                title="Add premium forecasting",
                scenario_type="premium_feature_addition",
                description="desc",
                input_parameters={"premium_feature": "forecasting"},
            ),
            GeneratedScenarioResponse(
                title="Remove export",
                scenario_type="feature_removal",
