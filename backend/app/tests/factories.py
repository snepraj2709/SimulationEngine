...
def sample_scrape_result(url: str = "https://acme.example/") -> ScrapeResult:
    return ScrapeResult(
        ...
        raw_extracted_json={
            ...
            "pricing_clues": ["annual plans", "custom enterprise pricing"],
            "audience_candidates": ["revenue teams", "customer success leaders"],
            "feature_candidates": ["workflow automation", "renewal analytics", "customer health monitoring"],
        },
...
def sample_product_understanding() -> ProductUnderstanding:
    understanding = ProductUnderstanding(
        ...
        confidence_scores={
            ...
            "customer_logic": 0.79,
            "pricing_model": 0.78,
            "monetization_model": 0.77,
            "feature_clusters": 0.85,
            "business_model_signals": 0.76,
            "simulation_levers": 0.72,
        },
        warnings=[],
        raw_extracted_json=sample_scrape_result().raw_extracted_json,
        summary_line="Revenue workflow software for onboarding, renewals, and customer expansion.",
        ...
        business_model_signals=[
            {
                "key": "buyer_type",
                "label": "Buyer Type",
                "value": "Revenue and customer success teams",
                "confidence": 0.81,
                "editable": True,
            },
            {
                "key": "sales_motion",
                "label": "Sales Motion",
                "value": "Demo-led / enterprise sales",
                "confidence": 0.77,
                "editable": True,
            },
            {
        ...
        customer_logic={
            "core_job_to_be_done": "Automate onboarding, renewals, and expansion workflows for revenue teams.",
            "why_they_buy": [
                "Reduce manual customer lifecycle work",
                "Improve visibility into renewals and customer health",
                "Create a more scalable revenue operating rhythm",
            ],
            "why_they_hesitate": [
                "Implementation complexity may feel hard to estimate",
                "Pricing likely requires a sales process",
            ],
            "what_it_replaces": ["spreadsheets", "point tools", "internal workflows"],
        },
        monetization_model={
        ...
        feature_cluster_details=[
            {"key": "workflow-automation", "label": "workflow automation", "importance": "high", "description": "Automates lifecycle steps across teams."},
            {"key": "renewal-analytics", "label": "renewal analytics", "importance": "high", "description": "Tracks renewals and expansion health."},
            {"key": "customer-health", "label": "customer health", "importance": "medium", "description": "Surfaces account risk and opportunity signals."},
        ],
        simulation_levers=[
            {"key": "pricing", "label": "Pricing", "why_it_matters": "Pricing changes will directly influence expansion and renewal conversion.", "confidence": 0.78, "editable": True},
            {"key": "packaging", "label": "Packaging", "why_it_matters": "Contract structure and plan boundaries shape upsell paths.", "confidence": 0.77, "editable": True},
            {"key": "deployment_effort", "label": "Deployment Effort", "why_it_matters": "Rollout friction affects activation speed and proof requirements.", "confidence": 0.76, "editable": True},
            {"key": "proof_case_studies", "label": "Proof and Case Studies", "why_it_matters": "Trust signals matter when ROI requires a sales process.", "confidence": 0.74, "editable": True},
        ],
        uncertainties=[
            {
                "key": "pricing_visibility",
                "label": "Pricing visibility",
                "reason": "Public pricing details are incomplete, so packaging assumptions are partly inferred.",
                "severity": "high",
                "needs_user_review": True,
            }
        ],
        source_coverage={
            "fields_observed_explicitly": ["Company name", "Product summary", "Buyer audience", "Feature clusters", "Pricing visibility"],
            "fields_inferred": ["Deployment complexity", "Switching friction", "Expansion potential"],
            "fields_missing": ["Distinct product name"],
        },
    )
